    ...
    <div id="legal" className="page">
      ...
      <div className="container">
        ...
        <p>
          ...
          <br />
          El sitio web esmuybien.es (en adelante, Sitio Web) es titularidad
          conjunta de Antía Fernández Tejo, con NIF XXXX y de María Mediero
          Mayán con NIF 53179679 E (en adelante, Es bien): <br />
          <br />
          Dirección: Calle Nasa 76, Playa Honda <br />
          Teléfono: 679 248 023 <br />
          Correo electrónico: info@esbien.es <br />
          <br />
        </p>
        ...
        <p>
          ...
          Usuarios (en adelante, Servicios). <br />
          <br />
          Es bien se reserva la facultad de modificar, en cualquier momento, y
          sin aviso previo, la presentación y configuración del Sitio Web y de
          los Contenidos y Servicios que en él pudieran estar incorporados. El
          Usuario reconoce y acepta que en cualquier momento Es bien pueda
          interrumpir, desactivar y/o cancelar cualquiera de estos elementos que
          se integran en el Sitio Web o el acceso a los mismos. <br />
          <br />
          ...
          relativo al coste de conexión a través de la red de telecomunicaciones
          suministrada por el proveedor de acceso que hubiere contratado el
          Usuario. <br />
          <br />
          La utilización de los Contenidos no requiere previa suscripción o
          registro alguno. <br />
          <br />
        </p>
        <h4>El Usuario</h4>
        <p>
          ...
          espacios habilitados para interactuar entre los Usuarios, y el Usuario
          y Es bien, incluidos los espacios de comunicación a través de otras
          plataformas y/o espacios de blogging, confiere la condición de
          ...
          leerlas cada vez que visite el Sitio Web. <br />
          <br />
          ...
          por Es bien sin que sea contrario a lo dispuesto por las presentes
          ...
          mismo funcionamiento del Sitio Web. <br />
          <br />
          -La veracidad y licitud de las informaciones aportadas por el Usuario
          en los contactos con Es bien para recibir información o acceder a
          ciertos Contenidos o Servicios ofrecidos por el Sitio Web. En todo
          caso, el Usuario notificará de forma inmediata a Es bien acerca de
          cualquier hecho que permita el uso indebido de la información
          registrada por dichas vías, tales como, pero no solo, el robo,
          extravío, o el acceso no autorizado a identificadores y/o contraseñas,
          con el fin de proceder a su inmediata cancelación. <br />
          <br />
          Si procede, Es bien se reserva el derecho de retirar todas aquellas
          aportaciones o comentarios que vulneren la ley, el respeto a la
          dignidad de la persona, que sean discriminatorios, xenófobos,
          racistas, pornográficos, spamming, que atenten contra la juventud o la
          infancia, el orden o la seguridad pública o que, a su juicio, no
          resultaran adecuados para su publicación. <br />
          <br />
          En cualquier caso, Es bien no será responsable de las opiniones
          vertidas por los Usuarios a través de comentarios u otras herramientas
          de blogging o de participación que pueda haber. <br />
          <br />
          El mero acceso a este Sitio Web no supone entablar ningún tipo de
          relación de carácter comercial entre Es bien y el Usuario. <br />
          <br />
          Siempre en el respeto de la legislación vigente, este Sitio Web de Es
          bien se dirige a todas las personas, sin importar su edad, que puedan
        ...
        <p>
          ...
          Sitio Web, ni de los Contenidos o Servicios. Es bien hará todo lo
          posible por el buen funcionamiento del Sitio Web, sin embargo, no se
          responsabiliza ni garantiza que el acceso a este Sitio Web no vaya a
          ser ininterrumpido o que esté libre de error. <br />
          <br />
          ...
          Usuario. En ningún caso Es bien será responsable por las pérdidas,
          daños o perjuicios de cualquier tipo que surjan por el acceso,
          navegación y el uso del Sitio Web, incluyéndose, pero no limitándose,
          a los ocasionados a los sistemas informáticos o los provocados por la
          introducción de virus. <br />
          <br />
          Es bien tampoco se hace responsable de los daños que pudiesen
          ...
          ocurrir. <br />
          <br />
          Es bien no será responsable del uso que terceros hagan de la
        ...
        <p>
          ...
          exhaustivo, imágenes, sonido, audio, vídeo, software o textos, marcas
          o logotipos, combinaciones de colores y fuentes, estructura y diseño,
          selección de materiales usados, programas de ordenador necesarios para
          su funcionamiento, acceso y uso, cualquier otro signo distintivo,
          etc.). Serán, por consiguiente, obras protegidas como propiedad
          intelectual por el ordenamiento jurídico español, siéndoles aplicables
          tanto la normativa española y comunitaria en este campo, como los
          ...
          cualquier medio técnico, sin la autorización de Es bien. <br />
          <br />
          El Usuario se compromete a respetar los derechos de propiedad
          intelectual e industrial de Es bien. Podrá visualizar los elementos
          del Sitio Web o incluso imprimirlos, copiarlos y almacenarlos en el
          disco duro de su ordenador o en cualquier otro soporte físico siempre
          y cuando sea, exclusivamente, para su uso personal. El Usuario, sin
          embargo, no podrá suprimir, alterar, o manipular cualquier dispositivo
          de protección o sistema de seguridad que estuviera instalado en el
          Sitio Web. <br />
          <br />
          ...
          inmediatamente a Es bien a través de los datos de contacto del
        ...
        <p>
          Es bien se reserva la facultad de presentar las acciones civiles o
          ...
          Condiciones. <br />
          <br />
          La relación entre el Usuario y Es bien se regirá por la normativa
          ...
          estas Condiciones las partes someterán sus conflictos a la
          jurisdicción ordinaria sometiéndose a los jueces y tribunales que
          correspondan conforme a derecho. <br />
        </p>
      </div>
